...
unlocked to sign the BitcoinBridge-Qt.app bundle.
...
allowing somebody to distribute a BitcoinBridge-Qt.app or bitcoinbridge-qt-setup.exe with a valid
...
that the bitcoinbridge-qt.exe file inside the installer had not been tampered with.
