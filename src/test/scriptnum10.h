...
#ifndef BITCOINBRIDGE_TEST_SCRIPTNUM10_H
#define BITCOINBRIDGE_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinBridge Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINBRIDGE_TEST_BIGNUM_H
