...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if (isPrivkey) {
            ...
            // Note: CBitcoinBridgeSecret::SetString tests isValid, whereas CBitcoinBridgeAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    CBitcoinBridgeAddress dummyAddr;
