...
#if defined(NDEBUG)
#error "BitcoinBridge cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "BitcoinBridge Signed Message:\n";
...
{
    RenameThread("bitcoinbridge-scriptch");
