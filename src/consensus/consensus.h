...
#ifndef BITCOINBRIDGE_CONSENSUS_CONSENSUS_H
#define BITCOINBRIDGE_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinBridge parameters, but if this fork is a fork
...
#endif // BITCOINBRIDGE_CONSENSUS_CONSENSUS_H
