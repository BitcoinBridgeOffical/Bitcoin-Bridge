...
#ifndef BITCOINBRIDGE_QT_SENDCOINSDIALOG_H
#define BITCOINBRIDGE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinbridges */
...
#endif // BITCOINBRIDGE_QT_SENDCOINSDIALOG_H
