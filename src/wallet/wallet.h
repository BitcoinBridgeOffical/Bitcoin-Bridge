...
#ifndef BITCOINBRIDGE_WALLET_WALLET_H
#define BITCOINBRIDGE_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinbridge node, and set to 0 for transactions that were created
...
#endif // BITCOINBRIDGE_WALLET_WALLET_H
