...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinBridgeTestFramework
    pass

class ExampleTest(BitcoinBridgeTestFramework):
    # Each functional test is a subclass of the BitcoinBridgeTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinBridgeTestFramework class so other tests can use it."""
