...
class BIP66Test(BitcoinBridgeTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinbridged is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinbridged produces more specific reject
            # reasons.
