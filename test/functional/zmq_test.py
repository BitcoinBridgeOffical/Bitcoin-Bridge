...
from test_framework.test_framework import BitcoinBridgeTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinBridgeTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoinbridge has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoinbridged has not been built with zmq enabled.")
