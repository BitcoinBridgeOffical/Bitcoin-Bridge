...
# TestNode: A peer we use to send messages to bitcoinbridged, and store responses.
...
class CompactBlocksTest(BitcoinBridgeTestFramework):
    ...
    # This test actually causes bitcoinbridged to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinbridged's choice of nonce.
    ...
    # Test that bitcoinbridged requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinbridged to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinbridged will not send blocktxn responses for blocks whose height is
