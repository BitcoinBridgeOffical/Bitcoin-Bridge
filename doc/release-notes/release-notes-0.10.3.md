BitcoinBridge Core version 0.10.3 is now available from:

  <https://bitcoinbridge.org/bin/bitcoinbridge-core-0.10.3/>
...
(see https://github.com/bitcoinbridge/bitcoinbridge/pull/6793, as well as the 0.11.0
