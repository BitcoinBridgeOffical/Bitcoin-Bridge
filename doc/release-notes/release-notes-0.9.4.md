BitcoinBridge Core version 0.9.4 is now available from:

  https://bitcoinbridge.org/bin/0.9.4/
...
this update is incompatible with the BitcoinBridge system and could lead to consensus
forks.

BitcoinBridge Core released binaries from https://bitcoinbridge.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinbridge/+archive/ubuntu/bitcoinbridge
- A third-party or self-compiled BitcoinBridge Core

upgrade to BitcoinBridge Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
