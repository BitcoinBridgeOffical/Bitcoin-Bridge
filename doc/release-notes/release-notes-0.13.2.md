BitcoinBridge Core version 0.13.2 is now available from:

  <https://bitcoinbridge.org/bin/bitcoinbridge-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinbridge-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinbridge-tx to create v2 transactions (btcdrak)
