BitcoinBridge-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinbridge/files/BitcoinBridge/bitcoinbridge-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinBridge
...
New/changed settings (command-line or bitcoinbridge.conf file)
--------------------------------------------------------
