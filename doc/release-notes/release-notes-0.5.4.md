BitcoinBridge version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinbridge/files/BitcoinBridge/bitcoinbridge-0.5.4/
...
http://gitorious.org/bitcoinbridge/bitcoinbridged-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinBridge-Qt notifications under Growl 1.3.
Increase required age of BitcoinBridge-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinBridge properly when installing BitcoinBridge-Qt over it. (Windows)
