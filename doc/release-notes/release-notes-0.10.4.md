BitcoinBridge Core version 0.10.4 is now available from:

  <https://bitcoinbridge.org/bin/bitcoinbridge-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinbridge-tx into its own package
- #6953 `dfe0d4d` Include bitcoinbridge-tx binary on Debian/Ubuntu
